...
class SensorService
{
	...
	public function saveEditSensor($id, $input){
		$sensor=Sensor::find($id);
		$sensor->nome = $input["nome"];
		$sensor->modelo = $input["modelo"];
		$sensor->area_alcance = $input["area_alcance"];
		$sensor->tipo_id = $input["tipo_id"];
		$sensor->save();
	}
}
