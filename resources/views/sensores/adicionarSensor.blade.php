		...
		<div class="panel-body">
			<form id="registerForm" method="POST" action="/admin/sensores/adicionar/submit" >
				...
				<div class="form-group">
					<h4 class="border-bottom sm-margin-left">Dados do Novo Sensor</h4>
					<div class="col-xs-12 col-md-12">
						...
						<div class="input-group margin-bottom">
							<input type="number" class="form-control" id="area_alcance"  name="area_alcance" placeholder="Insira o alcance do sensor" required="" min=0><span class="input-group-addon">metros</span>
						</div>
					</div>
