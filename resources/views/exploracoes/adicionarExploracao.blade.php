								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-md-12 margin-bottom">
										...
										<div class="input-group margin-bottom">
											<input value="{{old('nome')}}" type="text" class="form-control" id="nome"  name="nome" placeholder="Insira o nome do terreno" required><span class="input-group-addon"><i class="glyphicon glyphicon-asterisk"></i></span>		
										</div>
										<label for="numero">Número do Terreno</label>
										<div>
											<input value="{{old('numero')}}" type="number" class="form-control" id="numero"  name="numero" min=0 placeholder="Insira o número de registo do terreno">
										</div>
									</div>
								</div>
								<div class="form-group">
										...
										<div class="row">
											<div class="col-lg-6 ">	
												...
												<div class="margin-bottom">
													<input value="{{old('distrito')}}" type="text" class="form-control" id="distrito" name="distrito" placeholder="Insira o distrito onde se localiza o terreno" >
												</div>
												<label for="concelho">Concelho</label>
												<div>
													<input value="{{old('concelho')}}" type="text" class="form-control" id="concelho" name="concelho" placeholder="Insira o concelho onde se localiza o terreno" >
												</div>
											</div> 
											...
											<div class="col-xs-12 col-md-6"> 
												...
												<div>
													<input value="{{old('freguesia')}}" type="text" class="form-control" id="freguesia"  name="freguesia" placeholder="Insira a freguesia onde se localiza o terreno">
												</div>
											</div> 
										</div> 
									</div>    
